...
程序实现步骤如下图所示：
![程序实现步骤图](1.png "程序实现步骤图")
## 四、实验结果
### 1.实验截图
![程序实现步骤图](2.png "程序实现步骤图")
旋转中的茶壶图像如下：
![程序实现步骤图](3.png "程序实现步骤图")
![程序实现步骤图](4.png "程序实现步骤图")
更改纹理参数后的茶壶图像如下：
![程序实现步骤图](5.png "程序实现步骤图")
![程序实现步骤图](6.png "程序实现步骤图")
更改光源位置后的茶壶图像如下：
![程序实现步骤图](7.png "程序实现步骤图")
![程序实现步骤图](8.png "程序实现步骤图")
### 2.分析结果及存在问题
...
### 3．实验体会与小结
- 1.通过本次的计算机图形学综合实验，我更加熟悉了基础图形的绘制，可以利用所学知识绘制基本、简单的二维、三维图形；
- 2.深入了解到很多图形绘制算法，比如添加纹理、光照等绘制效果，这些效果的加入将会使绘制的图形更加真实、生动，可以使图形的展示不再局限于普通的二维效果；
- 3.在实现各种效果的过程中我遇到了很多问题，大多数问题都是由于对OpenGL的各类函数不熟悉，通过不断上网查阅资料、查阅文献、询问老师同学，我对于各类函数的调用更加熟悉、也掌握了各类图形绘制的算法；
- 4.本次实验仍存在一定的问题，在键盘控制图形旋转方面有很大的进步空间，虽本次实验未能完全解决存在的问题，但我会在结课后继续深入研究、思考问题的解决方法，继续学习计算机图形学的相关内容。
## 五、参考文献
